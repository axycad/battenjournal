...
import {
  ...
  getNotificationCountsPerCaseAPI,
  type NotificationCounts,
  type CaseNotificationCounts,
  type TaskWithCase,
} from '@/lib/api'
...
export default function DashboardPage() {
  ...
  const [myTasks, setMyTasks] = useState<TaskWithCase[]>([])
  ...
  const [caseNotifications, setCaseNotifications] = useState<CaseNotificationCounts[]>([])
  ...
  useEffect(() => {
    async function loadData() {
      try {
        const [casesData, tasksData, notifCounts, caseNotifs] = await Promise.all([
          getCasesAPI(),
          getMyTasksAPI(),
          getNotificationCountsAPI(),
          getNotificationCountsPerCaseAPI(),
        ...
        setCaseNotifications(caseNotifs)
      } catch (err) {
      ...
      <div className="max-w-4xl mx-auto px-md py-lg">
        <div className="flex items-center justify-center py-xl">
          <div className="text-center">
            ...
            <p className="text-body text-text-secondary">Loading your dashboard...</p>
          </div>
        </div>
      </div>
    )
